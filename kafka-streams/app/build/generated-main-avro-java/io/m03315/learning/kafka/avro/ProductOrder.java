...
public class ProductOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4239108076091831922L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductOrder\",\"namespace\":\"io.m03315.learning.kafka.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"product\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"user_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"time\",\"type\":\"long\"}]}");
   ...
   */
  public static io.m03315.learning.kafka.avro.ProductOrder.Builder newBuilder() {
    return new io.m03315.learning.kafka.avro.ProductOrder.Builder();
  }
   ...
   * @return A new ProductOrder RecordBuilder
   */
  public static io.m03315.learning.kafka.avro.ProductOrder.Builder newBuilder(io.m03315.learning.kafka.avro.ProductOrder.Builder other) {
    if (other == null) {
      return new io.m03315.learning.kafka.avro.ProductOrder.Builder();
    } else {
      return new io.m03315.learning.kafka.avro.ProductOrder.Builder(other);
    }
  }
   ...
   * @return A new ProductOrder RecordBuilder
   */
  public static io.m03315.learning.kafka.avro.ProductOrder.Builder newBuilder(io.m03315.learning.kafka.avro.ProductOrder other) {
    if (other == null) {
      return new io.m03315.learning.kafka.avro.ProductOrder.Builder();
    } else {
      return new io.m03315.learning.kafka.avro.ProductOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.m03315.learning.kafka.avro.ProductOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.m03315.learning.kafka.avro.ProductOrder other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder setProduct(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder setUserId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder clearUserId() {
      user_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.m03315.learning.kafka.avro.ProductOrder.Builder clearTime() {
